...
update_response_format = '''
{
  ...
  "schema": {
    ...
    "properties": {
      ...
      "grade": {
        "type": "object",
        "description": "The grade received for the quest, structured according to the rubric. For rubrics with multiple criteria, provide scores for each criterion. For simple rubrics, provide a single overall score. Optional for teacher conversations.",
        "additionalProperties": true
      },
      "overall_score": {
        "type": "string",
        "description": "The overall grade or score summary (e.g., '4/5', 'B+', '23/30 points', etc.) based on the rubric structure. Optional for teacher conversations."
      },
      "feedback": {
        "type": "string",
        "description": "Comments or feedback about the quest. Optional for teacher conversations."
      },
      "change": {
        "type": "boolean",
