...
from slides_generator.agents.content_writer_agent import ContentWriterAgent
from slides_generator.models.slide_plan import SlideContent
...
async def test_writer_returns_slide_content():
    ...
    with patch("slides_generator.agents.content_writer_agent.Runner") as mock_runner:
