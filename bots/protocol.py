...
class BotProviderProtocol(Protocol):
    ...
    def create_misconception_seeder(self) -> Any: ...

    def create_pii_redactor(self) -> Any: ...

    def create_artifact_extractor(self) -> Any: ...

    def create_pretest_agent(self) -> Any: ...

    def create_misconception_agent(self) -> Any: ...

    def create_teaching_agent(self) -> Any: ...
