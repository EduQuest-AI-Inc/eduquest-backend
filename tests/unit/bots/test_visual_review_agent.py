"""Tests for VisualReviewAgent. Lives in unit/bots/ to use real_bots_imports fixture."""
...
def test_review_returns_approved(dummy_image):
    ...
    with patch("bots.slideshow.visual_review_agent.OpenAI") as mock_openai_cls:
        ...
        result = VisualReviewAgent().review(
