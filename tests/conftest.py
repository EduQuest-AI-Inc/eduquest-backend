...
sys.modules['EQ_agents.profile_agent'] = MagicMock()
sys.modules['EQ_agents.ltg_agent'] = MagicMock()
sys.modules['EQ_agents.grading_agent'] = MagicMock()
sys.modules['EQ_agents.teacher_feedback_agent'] = MagicMock()
sys.modules['EQ_agents.schedule_agent'] = MagicMock()
sys.modules['EQ_agents.guardrails'] = MagicMock()
sys.modules['EQ_agents.ltg_conversation_service'] = MagicMock()
