...
echo "3. Restart backend: sudo systemctl restart eduquest-backend  (or: pkill -f 'uvicorn main:app' && nohup venv/bin/python -m uvicorn main:app --host 0.0.0.0 --port 8000 > app.log 2>&1 &)"
